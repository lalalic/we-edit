	...
	return (
		<ToolbarGroup>			
			...
			<DropDownButton 
				...
				<MenuItem primaryText="Portrait" leftIcon={<SvgIcon children={<IconBlank/>}/>} onClick={protrait}/>
				<MenuItem primaryText="Landscape"  leftIcon={<SvgIcon  children={<IconBlank transform="translate(25 0) rotate(90)" />} />} onClick={landscape}/>
			</DropDownButton>
			...
			<DropDownButton 
				...
				title="page size"
				icon={<IconSize/>}>
				<MenuItem primaryText="Letter" leftIcon={<SvgIcon/>} onClick={e=>size(21.59,27.94)}/>
				<MenuItem primaryText="Legal" leftIcon={<SvgIcon/>} onClick={e=>size(21.59,35.56)}/>
				<MenuItem primaryText="A3" leftIcon={<SvgIcon/>} onClick={e=>size(29.7,42.01)}/>
				<MenuItem primaryText="A4" leftIcon={<SvgIcon/>}  onClick={e=>size(20.99, 29.7)}/>
